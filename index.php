<?php 
   session_start(); 
    $arrProducts = array(
        array(
            'name'          => "Men Letter Graphic Zip-up Hooded Jacke",
        ...
        array(
            'name'          => "Men Cartoon Graphic Drawstring Hooded Sweatshirt",
            'description'   => "lorem is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book..",
            'price'         => "328",
            'photo1'        => 'produc2A.jpg',
            'photo2'        => 'produc2B.jpg',
        ...
        array(
            'name'          => "Men Slogan Graphic Striped Trim Drop Shoulder Varsity Jacket Without Hoodie",
            'description'   => "lorem is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book..",
            'price'         => "524",
            'photo1'        => 'produc3A.jpg',
            'photo2'        => 'produc3B.jpg',
        ...
        array(
            'name'          => "Men Letter Embroidery Striped Trim Teddy Bomber Jacket",
            'description'   => "lorem is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book..",
            'price'         => "992",
            'photo1'        => 'produc4A.jpg',
            'photo2'        => 'produc4B.jpg',
        ...
        array(
            'name'          => "Men Slant Pocket Hooded Coat",
            'description'   => "lorem is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book..",
            'price'         => "650",
            'photo1'        => 'produc7A.jpg',
            'photo2'        => 'produc7B.jpg',
        ...
        array(
            'name'          => " Men Flap Pocket Drawstring Hooded Coat Without Tee ",
            'description'   => "lorem is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book..",
            'price'         => "1,070",
            'photo1'        => 'produc8A.jpg',
            'photo2'        => 'produc8B.jpg',
